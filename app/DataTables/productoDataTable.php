...
use App\Models\Producto; // ← StudlyCase
use Yajra\DataTables\Html\Column;
use Yajra\DataTables\Html\Button;
use Yajra\DataTables\Services\DataTable;

class productoDataTable extends DataTable // ← StudlyCase
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('id', fn (Producto $producto) => $producto->id)
            ->rawColumns(['action']);
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->responsive(true)
            ->stateSave(false)
            ->orderBy(0, 'desc') // orden por la 1a columna (id)
            ->dom('
                <"row mb-2"
